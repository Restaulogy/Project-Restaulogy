...
<meta name="apple-mobile-web-app-capable" content="yes" />
 ...
 <title>Restaurants</title>
	<META NAME="Description" CONTENT="Organize your health information all in one place to get practical, personalized guidance that stays up to date as your needs change.">
	...
	<body>
		...
		<div data-role="content">
			...
			<div class="biz_center" style='font-weight:normal;'>
				We are really sorry for this inconvenience but there was an error when processing your order. Please contact the site administrator. To go to the main page please <a href="<?php echo $website;?>/user/tbl_orders.php">click here</a>
			</div>
		</div>
