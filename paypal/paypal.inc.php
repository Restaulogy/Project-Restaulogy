...
$paypal = array();
//$paypal['business']    = "bizsel_1260418092_biz@gmail.com";
$paypal['business']    = "restaurant_seller@gmail.com";
//$paypal['business']      = $_SESSION[SES_PAYPAL_EMAIL];
//$paypal['site_url']="http://localhost/golf/";
$paypal['site_url']=$website;//."mod/UniversalCalendar/MockupPlanner/";
$paypal['image_url']     = "";
$paypal['success_url']   = "/user/paypal_result.php?is_success=1";
$paypal['cancel_url']    = "/user/paypal_result.php?is_success=0";
$paypal['notify_url']    = "/paypal/devipn.php";
...
$paypal['continue_button_text']     = "CLOSE AND RETURN TO SITE Continue >>";
...
//$paypal['playername']   = isset($_POST['playername']) ? $_POST['playername']: "";
//$paypal['email']   = isset($_POST['email']) ? $_POST['email']: "";
//$paypal['country']   = isset($_POST['country']) ? $_POST['country']: "";
...
*/
//..These constants are for the paypal NVP credentials
$environment = 'sandbox';	// or 'beta-sandbox' or 'live'
$my_api_username='restaurant_seller_api1.gmail.com';
$my_api_password='1378266614';
$my_api_signature='AlpWnv4blVQyLM6tIyWChnPpmIi0AAwqWa2jIEKw08qIqDC-v6OwbVHj';	
...
function PPHttpPost($methodName_, $nvpStr_) {
	global $environment,$my_api_username,$my_api_password,$my_api_signature;	
