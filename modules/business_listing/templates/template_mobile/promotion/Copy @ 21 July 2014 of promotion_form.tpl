...
<fieldset style="border: 1px solid #ccc;margin:5px;padding:5px;">
    <legend><label> Basic Details</label></legend>
        ...
        <tr>
         ...
         <tr id="prom_code_row">
             <td class="detail_right_td">Code<font color="red">*</font></td>
			<td class="detail_left_td">
         ...
         <tr >
			...
			<td class="detail_left_td">
                ...
                <select name="cupon_type" id="cupon_type" onchange="change_cupons();">
                    ...
                    <option value="all_site" {if $promotion.cupon_type eq 'all_site'}selected{else}{if $coupon_type eq "all_site"}selected{else}{/if}{/if}>One time {$_lang.lbl_coupon} </option>
                   <!--
        ...
        <tr id="is_event">
             <td class="detail_right_td">Is event</td>
			<td class="detail_left_td">
                   <input type="checkbox" value="1" id="is_event" name="is_event" {if $promotion.is_event eq 1}checked='checked'{/if} />
 ...
 <fieldset style="border: 1px solid #ccc;margin:5px;padding:5px;display:none;">
    <legend><label> Discount Details</label></legend>
       <table class="job_detail_panal_table">
		...
		<tr id="disc_aply_type_row">
			...
			<td class="detail_left_td">
				<select name="disc_aply_type" id="disc_aply_type" onchange="toggle_btn_discount(this.value);">
               ...
               <!-- &nbsp;<a href="#" title="what is this?" style="background:url('{$elgg_main_url}images/_graphics/icon_bookmarkthis.gif') 0px 0px no-repeat;  padding-left:20px;font-size:12px !important;font-weight:bold;color:#6a18b6;font-family:  Verdana, Arial, Helvetica, sans-serif; height:55px !important;" onclick="return overlib('<table  class=\'inside_popup\' style=\'font-family:  Verdana, Arial, Helvetica, sans-serif;width:290px;font-size:10px !important;\'><tr><td colspan=\'2\' class=\'top_line\'><span style=\'width:290px;text-align:left;padding-left:15px;line-height:20px;font-size:12px;font-weight:bold;color:Gray;\'>Apply Type</span><br><b>1. Complete bill </b> - Using this you can add discount on the total Bill (by providing only Discounted Amount)...<br><b>2. Individual Item </b> - Using this you add Buy one get one free/50% both the items from the same sub menu and from different sub menus (by providing only Purchase Required).Also you can able to add particular item disocunt (by providing only Discounted items)..<br><b>3. Fixed Price -</b> Using this you can buy 3 of the same sub menu for $ x or you can buy 2-3 different sub menu items for $ x amount - like a combo deal (by providing prurchse required and disocunt amount amount).<br><b>4 - Condition Discount -</b> Using this you can add discount like When you buy 2 you get off on the 2 items u buy and with sub menu and dish combinations (by providing prurchase required and discount amount)..<br><br><a href=\'#\' style=\'float:right;\' onclick=\'return cClick();\'>close</a></td></tr><tr><td colspan=\'2\' style=\'text-transform: lowercase !important;\'>{$varPromPath}</td></tr><tr><td colspan=\'2\' class=\'bottom_line\'></td></tr></table>',STICKY);" >what is this?</a>-->
		 ...
		 <tr id="disc_amt_row" {if $promotion.disc_aply_type neq 'ITEM'}{else}style='display:none;'{/if}>
            <td class="detail_right_td">Discount Amount ($)<font color="red">*</font></td>
			<td class="detail_left_td">
			...
			<tr>
					...
					<td class="biz_top_align" id="td_disc_amt_type" >
    					<select name="disc_amt_type" id="disc_amt_type" >
                            <option value="VALUE" {if $promotion.disc_amt_type eq 'VALUE'}selected='selected'{/if}>$</option>
...
<div data-role="popup" id="popupBasic" style="width:270px;" data-theme="a" data-overlay-theme="g" data-dismissible="false">
 ...
 <div data-role="content" style="padding:5px;font-family:Arial !important;font-size:12px !important;"><b>1. Complete bill </b> - Using this you can add discount on the total Bill (by providing only Discounted Amount)...<br><b>2. Individual Item </b> - Using this you add Buy one get one free/50% both the items from the same sub menu and from different sub menus (by providing only Purchase Required).Also you can able to add particular item disocunt (by providing only Discounted items)..<br><b>3. Fixed Price -</b> Using this you can buy 3 of the same sub menu for $ x or you can buy 2-3 different sub menu items for $ x amount - like a combo deal (by providing prurchse required and disocunt amount amount).<br><b>4 - Condition Discount -</b> Using this you can add discount like When you buy 2 you get off on the 2 items u buy and with sub menu and dish combinations (by providing prurchase required and discount amount)..</div> 
...
if ($('#chk_cond_daytime').is(':checked')) {
	...
	function toggle_btn_discount(sel_val){
        //$("#td_disc_amt_type").show(); 
       $("#disc_amt_row").show();
        if(sel_val=='ORDER'){
           $("#btn_discount").hide();
           $("#btn_conditions").hide();
           ...
           $("#btn_discount").hide(); 
           //$("#disc_amt_type").val('VALUE');
           $("#promotion_form #disc_amt_type").val('VALUE');
