<div data-role="popup" id="pop_email_friend" data-dismissible="false" style="width:270px;border:1px solid #FF9600;" data-overlay-theme="a">
		...
		{/if}
            ...
            <div class="biz_center">
                ...
                <input type="button" data-icon="delete" data-inline="true" onclick="$('#pop_email_friend').popup('close');" value="{$_lang.cancel_lbl}"/>
			</div><!--/.field-row-->
