<?php
	...
	$style = $vars['style'];
  	...
  	if ((isset($vars['extra_attribute']))  && ((strlen(trim($vars['extra_attribute'])))!=0))
		$extra_attribute_string =  $vars['extra_attribute'];
	else
...
<script language="javascript" type="text/javascript">
   tinyMCE.init({
	...
	theme : "advanced",
	relative_urls : false,
	theme_advanced_buttons1 : "bold,italic,underline,separator,strikethrough,forecolor,bullist,numlist,undo,redo,link,unlink,image,blockquote,code",
...
<textarea class="input-textarea" name="<?php echo $vars['internalname']; ?>" <?php if (isset($vars['internalid'])) echo "id=\"{$vars['internalid']}\""; ?> <?php if ($vars['disabled']) echo ' disabled="yes" '; ?> <?php echo $vars['js']; ?> style="<?php echo $style; ?>" <?php echo $extra_attribute_string?>><?php echo htmlentities($vars['value'], ENT_QUOTES, 'UTF-8'); ?></textarea>
