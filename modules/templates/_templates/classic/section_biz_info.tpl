<table cellspacing="0" border="0" cellpadding="0" width="100%">
  <tr>
    ...
    <h1 style="font-size:18px; font-family: Georgia, 'Times New Roman', Times, serif; color: {$ELGG_BLUE};">{$theme_lang.biz_info_lable}</h1>
...
{if $info.template_content.firm && $info.template_content.firm neq "" && $info.template_content.firm|strlen gt 0}
    ...
    {if $info.template_content.firm_map_link}
        <a target="_blank" href="{$info.template_content.firm_map_link}">Map</a><br/>
	{/if}
