<div class="navTable">
	<table class="navTable" style="width:100%">
		<tr>
                ...
                <th {if $active_page eq "tbl_dishes"}class="active"{else}class="link" onclick='window.location.href="{$website}/user/tbl_feedback_stats.php";'{/if}>{$_lang.tbl_feedback.feed_stats}</th>
